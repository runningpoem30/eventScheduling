    ...
    <div className="absolute top-0 left-0 w-full mt-[50px] border-b-2 border-b-black-100 ">
        <nav className="flex mb-[5px]  ">
          ...
          <ul className="flex gap-[50px] ml-[400px] ">
            <li className="text-[18px] text-[#2C2C2C] font-medium">Product</li>
            <li className="text-[18px] text-[#2C2C2C] font-medium">Solutions</li>
            <li className="text-[18px] text-[#2C2C2C] font-medium">Enterprise</li>
            <li className="text-[18px] text-[#2C2C2C] font-medium">Pricing</li>
            <li className="text-[18px] text-[#2C2C2C] font-medium">Resources</li>
            <li className="text-[15px] text-[#2c2c2c] font-medium mt-[3px]">Signup</li>
          </ul>
